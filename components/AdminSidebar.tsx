...
const managementLinks = [
    ...
    { id: 'course-structure', label: 'Course Structure Management' },
    { id: 'user-management', label: 'User Management' },
    { id: 'quiz-management', label: 'Quiz Management' },
    { id: 'flashcard-management', label: 'Flashcard Management' },
    { id: 'qa-management', label: 'Q&A Management' },
    { id: 'reports', label: 'Reports' },
];

export const AdminSidebar: React.FC<AdminSidebarProps> = ({ isOpen, activePage, setActivePage }) => {
  return (
