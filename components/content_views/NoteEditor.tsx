    ...
    return (
        <div ref={wrapperRef} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-5 w-full note-editor-container">
            ...
            <div className="mt-4 flex justify-end space-x-3">
                <button onClick={onCancel} className="px-4 py-2 rounded-md text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-600 hover:bg-gray-200 dark:hover:bg-gray-500">Cancel</button>
                <button onClick={handleSaveClick} className="px-4 py-2 rounded-md text-white bg-blue-600 hover:bg-blue-700">Save Note</button>
            </div>
        </div>
    );
};