    ...
    <div className="bg-white dark:bg-gray-800/50 shadow-md rounded-lg flex flex-col h-[calc(100vh-14rem)] min-h-[300px]">
        <div className="p-3 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center shrink-0">
            ...
            <button
                ...
                className="p-1.5 rounded-full text-blue-600 dark:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-700 disabled:text-gray-400 dark:disabled:text-gray-500 disabled:cursor-not-allowed disabled:hover:bg-transparent"
...
export const ClassManagement: React.FC = () => {
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 h-full flex flex-col">
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Course Structure Management</h1>
